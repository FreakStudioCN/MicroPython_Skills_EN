...
Translate confirmed MicroPythonOS App requirements into code. Default to a two-phase flow:

1. **Confirmation Phase**: Read-only context, output a generation/update plan listing files to be created or modified, version strategy, dependency integration, icon plan, and validation commands, and ask the user for confirmation. No files are modified in this phase.
...
2. CPython and MicroPython syntax validation:
