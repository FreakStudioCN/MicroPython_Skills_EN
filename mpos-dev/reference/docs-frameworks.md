...
Apps/network functions should use it preferentially, rather than writing temporary socket download logic manually.
...
When `internal_filesystem/lib/mpos/ui/testing.py` can be extended, do not write temporary helpers in tests.
