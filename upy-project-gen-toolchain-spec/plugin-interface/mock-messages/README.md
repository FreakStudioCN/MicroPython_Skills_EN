...
| `status-update.json` | status_update | ✅ Created — 9 samples, including four levels: info/success/warn/error |
...
| `phase-complete.json` | phase_complete | ✅ Created — Complete analyze phase results, including three artifact types: table/file_tree/markdown |
| `stream.json` | stream | ✅ Created — 7 samples, including two stream types: device_output and script_stdout |

After the interface documentation for each skill is finalized, supplement the skill-specific mock message samples to this directory accordingly.
